...
Currently available applets include:
	...
	[, [[, arping, ash, awk, basename, bunzip2, bzcat, cat, chgrp,
	...
	hostid, hwclock, id, ifconfig, kill, killall, less, ln, lock,
	logger, ls, md5sum, mkdir, mkfifo, mknod, mkswap, mktemp, mount, mv,
	nc, netmsg, netstat, nice, nslookup, ntpd, passwd, pgrep, pidof,
	ping, ping6, pivot_root, poweroff, printf, ps, pwd, readlink,
	reboot, reset, rm, rmdir, route, sed, seq, sh, sleep, sort,
	start-stop-daemon, stat, strings, switch_root, sync, sysctl, tail,
	tar, tee, telnet, telnetd, test, time, top, touch, tr, traceroute,
	true, udhcpc, umount, uname, uniq, uptime, vconfig, vi, wc, wget,
