...
static void lp5521_firmware_loaded(struct lp55xx_chip *chip)
{
	...
	if (fw->size > (LP5521_PROGRAM_LENGTH * 2 + 1)) {/* modified by wanghao  */
	...
	lp5521_update_program_memory(chip, fw->data, (fw->size - 1));/* modified by wanghao  */
}
...
static int lp5521_post_init_device(struct lp55xx_chip *chip)
{
	...
	/* add by wanghao */
	lp55xx_write(chip, LP5521_REG_R_PWM, 255);
	lp55xx_write(chip, LP5521_REG_G_PWM, 187);
