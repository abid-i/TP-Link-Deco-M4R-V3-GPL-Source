...
/*  by Huangwenzhong, 14Nov15 */
//#if CONFIG_TP_FLASH_SUPPORT
struct mtd_info *mtd_for_flash_chardev;
//#endif

EXPORT_SYMBOL_GPL(mtd_for_flash_chardev);
						...
						struct device_node *np)
{
	...
	/* M4_3 use flash 'en25qh256', could trigger kernel panic
	 *change to 'default', which same as M4_2
	 */
	if (jedec == 0x1c7019)
		jedec = 0x206019;
...
//#if CONFIG_TP_FLASH_SUPPORT/*  by Huangwenzhong, 14Nov15 */
