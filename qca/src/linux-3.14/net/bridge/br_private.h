...
struct net_bridge
{
    ...
    char    bridge_name_matrix[BRIDGE_DELIVER_DEV_NUM][BRIDGE_DELIVER_SUBDEV_NUM][BRIDGE_DELIVER_DEV_NAME_LEN];    
    char    bridge_group_matrix[BRIDGE_GROUP_MAX_TYPE][BRIDGE_GROUP_DEV_NUM][BRIDGE_DELIVER_DEV_NAME_LEN];
    u32     bridge_hyfi_extend_enable;    
    u32     bridge_deliver_enable;
    u32     bridge_deliver_link_state;
    u32     bridge_deliver_eth_to_2g_enable;
    u32     bridge_deliver_wireless_repeater_3addrees;
    u32     bridge_deliver_has_same_front_dut;
    u32     bridge_deliver_dbg;
    u32     bridge_deliver_psr_alias_rule;
#endif
...
int br_fdb_check_ring_packet(struct sk_buff *skb,
                        struct tp_db_fre_bridge_fdb_entry *p, u16 vid);
...
#ifdef CONFIG_BRIDGE_DELIVER_CONTROL 
void br_bridge_deliver_init(struct net_bridge *);
#else
#define br_bridge_deliver_init(x)
#endif
