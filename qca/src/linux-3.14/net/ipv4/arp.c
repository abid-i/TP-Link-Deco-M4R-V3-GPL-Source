...
#define _ARP_DUP_IP_CHECK_

#ifdef _ARP_DUP_IP_CHECK_
...
static void arp_timer_handle(unsigned long data)
{
	arp_count = 0;
...
struct neigh_table arp_tbl = {
	...
	.gc_interval	= 30 * HZ,
	.gc_thresh1	= 1,//128,/*  change to 1 by wanghao to resolve the arp table cannot be clean */
	.gc_thresh2	= 512,
	.gc_thresh3	= 1024,
};
