...
/* add by yangxv for httpd, 2016.11 */
#if defined(CONFIG_UIP_HTTPD)

#include <../lib/uip/uip.h>
#include <../lib/uip/uip_arp.h>
#include <../lib/uip/timer.h>
...
#endif /* CONFIG_UIP_HTTPD */

/* end added */
extern void set_led_all_off(void);
extern int g_upgrade_complete;
