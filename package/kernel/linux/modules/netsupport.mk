...
define KernelPackage/tipc
  SUBMENU:=$(NETWORK_SUPPORT_MENU)
  TITLE:=tipc support
  KCONFIG:= 
       CONFIG_TIPC=m \
	   CONFIG_TIPC_PORTS=2048 \
	   CONFIG_TIPC_MEDIA_DECO=y
  FILES:=$(LINUX_DIR)/net/tipc/tipc.ko 
  AUTOLOAD:=$(call AutoLoad,35,tipc)
endef

define KernelPackage/tipc/description
 Kernel module for tipc support.
endef

$(eval $(call KernelPackage,tipc))
